...
public class HandlerMessages extends Activity {
    ...
    static class UIHandler extends Handler {
        WeakReference<HandlerMessages> mParent;

        public UIHandler(WeakReference<HandlerMessages> parent) {
            mParent = parent;
        }

        @Override
        public void handleMessage(Message msg) {
            HandlerMessages parent = mParent.get();
            if (null != parent) {
                switch (msg.what) {
    ...
    Handler handler = new UIHandler(new WeakReference<HandlerMessages>(
            this));

    @Override
    public void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_handler_messages);
        ...
        otherButton.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(HandlerMessages.this, "I'm Working",
